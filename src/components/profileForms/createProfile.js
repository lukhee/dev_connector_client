            ...
            <form onSubmit = {(e)=> onSubmit(e)}>
                ...
                <>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" className="rounded-0 form-control form-control-sm font-weight-bold w-75 d-inline-block align-middle ml-2" value={youtube}  onChange={e => onChnage(e)} placeholder="youtube Url" name="youtube" />
                    </div>

                    <div className="form-group">
                        <i  style={{width: "30px"}} className="align-middle text-info fab fa-linkedin fa-2x"/>
                        <input type="text" className="rounded-0 form-control form-control-sm font-weight-bold w-75 d-inline-block align-middle ml-2" value={linkedin}  onChange={e => onChnage(e)} placeholder="Linkedin Url" name="linkedin" />
                    </div>
